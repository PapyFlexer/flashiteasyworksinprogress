...
{
	import com.flashiteasy.admin.components.GradientEditorClasses.GradientBox;
	import com.flashiteasy.admin.components.GradientEditorClasses.GradientSlider;
	...
	public class GradientEditor extends UIComponent
	{
		...
		private function addThumb(e:MouseEvent):void
		{
			...
			_gradientSlider.dispatchEvent(new Event("thumbChange"));
