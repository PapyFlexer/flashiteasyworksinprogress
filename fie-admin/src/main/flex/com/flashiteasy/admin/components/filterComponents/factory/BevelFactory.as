package com.flashiteasy.admin.components.filterComponents.factory
{
	...
	public class BevelFactory extends EventDispatcher implements IFilterFactory
	{
											...
											knockout:Boolean):String
		{
			...
			result += ColorStringFormatter.formatColorHex24(highlightColor) + "," + highlightAlpha.toString() + ",";
			result += ColorStringFormatter.formatColorHex24(shadowColor) + "," + shadowAlpha.toString() + ",";
