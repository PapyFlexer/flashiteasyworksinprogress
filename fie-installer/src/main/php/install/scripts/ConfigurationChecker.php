 ...
 */
 ...
 /*
  * y a-t-il deja une version installee ?
  * version de php ( requis 5+ )
  * structure de ce qui est uploadé, presence de fie-admin, etc...
  * est-ce qu'on a les droits d'ecriture sur le repertoire parent ?
  ...
  */
  class ConfigurationChecker
  {
		...
		public function setAllApplicationsAmfEndPointsAndRealPaths()
		{
			$appsProjectFileTemplate = "../fie-projects/fie-sample-app/xml/project.xml.template";
			$sampleAppProjectFile = "../fie-projects/fie-sample-app/xml/project.xml";
			$resFileTemplate = "../fie-admin/res/projects.xml.template";
			$resFile = "../fie-admin/res/projects.xml";
			$templateAppContent =  file_get_contents( $appsProjectFileTemplate );
