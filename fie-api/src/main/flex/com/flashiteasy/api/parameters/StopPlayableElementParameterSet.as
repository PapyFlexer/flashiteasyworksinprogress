...
package com.flashiteasy.api.parameters
{
	...
	// metadata
    [ParameterSet(description="Stop_Element",type="Reflection", groupname="Control")]
	/**
	 ...
	 * on stage.
	 */
	public class StopPlayableElementParameterSet extends AbstractParameterSet  implements IParameterSetStaticValues
	{
       ...
       [Parameter(type="Number", defaultValue="",row="0", sequence="1", label="Time")]
		/**
		 * the time to play
		 */
