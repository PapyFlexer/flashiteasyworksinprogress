...
package com.flashiteasy.api.parameters
{
	...
	/**
	 * The <code><strong>BurstParameterSet</strong></code> is the parameterSet
	 * that handles the masking of a control by a burst.It sets the 
	 * number of branches and the inner radius of the burst mask.
	 */

	public class BurstParameterSet extends AbstractParameterSet
	{
		...
		override public function apply(targ:IDescriptor):void
		{
			...
			{
				IMaskElementDescriptor(targ).drawBurstMask(numberOfBranch, innerDiameter, angle);
			}
		}

		/**
		 * Sets the start angle of the burst mask 
		 */
		...
		/**
		 * Sets the inner diameter of the burst mask
		 */
		...
		/**
		 * SSets the number of branches of the burst mask
		 */
