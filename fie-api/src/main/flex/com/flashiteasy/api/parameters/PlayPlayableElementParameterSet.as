...
package com.flashiteasy.api.parameters
{
	...
	import com.flashiteasy.api.core.action.IPlayableElementAction;
	...
	// metadata
    [ParameterSet(description="Play_Element",type="Reflection", groupname="Control")]
	/**
	 ...
	 * on stage.
	 */
	public class PlayPlayableElementParameterSet extends AbstractParameterSet  implements IParameterSetStaticValues
	{
       ...
       [Parameter(type="Number", defaultValue="0",row="0", sequence="1", label="Time")]
		/**
		 * the time to play
		 */
