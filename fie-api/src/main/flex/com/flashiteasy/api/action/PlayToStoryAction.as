...
package com.flashiteasy.api.action
{
	 ...
	 */
	public class PlayToStoryAction extends Action implements IStoryAction, ITimedElementAction, IStoppableElementAction
	{
		...
		protected var storyPage:Page;
		protected var _time:uint;
		protected var _timeStop:uint;

		/**
		 * Constructor
		 */
		public function PlayToStoryAction()
		{
			super();
		}
