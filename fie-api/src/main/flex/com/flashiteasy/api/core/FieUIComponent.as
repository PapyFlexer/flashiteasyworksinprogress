...
package com.flashiteasy.api.core {
    ...
    * @private
     ...
     * @playerversion Flash 9.0.28.0
     */
	public class FieUIComponent extends FieSprite {
		 /**
         ...
         * @playerversion Flash 9.0.28.0
         */
		public function FieUIComponent() {
			super();
			...
			StyleManager.registerInstance(this as UIComponent);
		...
		public function get focusManager():IFocusManager {
			...
			while (o) {
				if (FieUIComponent.focusManagers[o] != null) {
					return IFocusManager(FieUIComponent.focusManagers[o]);
				}
				o = o.parent;
			}
			return null;
		...
		public function set focusManager(f:IFocusManager):void {
			FieUIComponent.focusManagers[(this as UIComponent)] = f;
		}
