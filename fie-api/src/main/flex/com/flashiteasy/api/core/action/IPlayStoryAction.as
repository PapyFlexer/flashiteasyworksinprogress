...
package com.flashiteasy.api.core.action
{
	 ...
	 */
	public interface IPlayStoryAction
	{
		function setStoriesToTrigger( stories : Array , page : Page  ) : void
		function addStoryNameToStoriesNamesToPlay( value : String ) : void 
		function removeStoryNameFromStoriesNamesToPlay( value : String ) : void
