...
package com.millermedeiros.swffit {
	...
	public class SWFFit {
		...
		*/
		...
		public static function get innerH():int {
			return getValueOf("winH");
		}
		
		public static function get innerW():int {
			//return getValueOf("winW");
			return ExternalInterface.call("alertSize");
		}
	}
